...
module tb_matrix_mul_curxC_4x4;
    ...
    initial begin
        $display("=== tb: cur_4x4 * C ===");

        // test 1: simple increasing numbers
        ...
        #5;
        $display("Input:");
        $display("%d %d %d %d", cur_4X4_0_0, cur_4X4_0_1, cur_4X4_0_2, cur_4X4_0_3);
        $display("%d %d %d %d", cur_4X4_1_0, cur_4X4_1_1, cur_4X4_1_2, cur_4X4_1_3);
        $display("%d %d %d %d", cur_4X4_2_0, cur_4X4_2_1, cur_4X4_2_2, cur_4X4_2_3);
        $display("%d %d %d %d", cur_4X4_3_0, cur_4X4_3_1, cur_4X4_3_2, cur_4X4_3_3);

        $display("Result (cur * C) =");
        ...
        #5;
        $display("==== second test (with negatives) ====");
        $display("Result (cur * C) =");
        $display("%d %d %d %d", result_0_0, result_0_1, result_0_2, result_0_3);
        $display("%d %d %d %d", result_1_0, result_1_1, result_1_2, result_1_3);
        $display("%d %d %d %d", result_2_0, result_2_1, result_2_2, result_2_3);
