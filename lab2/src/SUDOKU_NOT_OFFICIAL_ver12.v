...
//Part 2 Comb Logic: only_cand_ele_idx[i]對應到map上的位置 (只有位置資訊)
...
always@(*)begin
    for(i=0;i<9;i=i+1)begin
        for(j=0;j<9;j=j+1)begin
            ...
            else begin  //row、col、blk reduction的情況
