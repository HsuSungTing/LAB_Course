    ...
    for(i=0;i<9;i=i+1)begin
        for(j=0;j<9;j=j+1)begin  //令k為[i][j]的blk index
            if(only_cand_ele_idx[0]!=4'd15&&(i==only_cand_row[0]&&j==only_cand_col[0]))updated_cand_map[i][j]=9'd0;
                ...
                if(only_cand_ele_idx[8]!=4'd15&&(i==only_cand_row[8]||j==only_cand_col[8]||cand_map_blk_dix[i][j]==only_cand_blk[8])&&candidate_map[i][j][only_cand_ele_idx[8]]==1'b1)
...
always@(posedge clk or negedge rst_n)begin
    ...
    //case 4 做完一次
        ...
        //case 2: check_row_HN
        if(only_cand_ele_idx[0]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[0]]<=4'd1; end //唯一候選1
        if(only_cand_ele_idx[1]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[1]]<=4'd2; end //唯一候選2
        if(only_cand_ele_idx[2]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[2]]<=4'd3; end //唯一候選3
        if(only_cand_ele_idx[3]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[3]]<=4'd4; end //唯一候選4
        if(only_cand_ele_idx[4]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[4]]<=4'd5; end //唯一候選5
        if(only_cand_ele_idx[5]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[5]]<=4'd6; end //唯一候選6
        if(only_cand_ele_idx[6]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[6]]<=4'd7; end //唯一候選7
        if(only_cand_ele_idx[7]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[7]]<=4'd8; end //唯一候選8
        if(only_cand_ele_idx[8]!=4'd15)begin map[HN_row_idx][only_cand_ele_idx[8]]<=4'd9; end //唯一候選9
        ...
        if(only_cand_ele_idx[0]!=4'd15)begin map[only_cand_ele_idx[0]][HN_col_idx]<=4'd1; end //唯一候選1
        if(only_cand_ele_idx[1]!=4'd15)begin map[only_cand_ele_idx[1]][HN_col_idx]<=4'd2; end //唯一候選2
        if(only_cand_ele_idx[2]!=4'd15)begin map[only_cand_ele_idx[2]][HN_col_idx]<=4'd3; end //唯一候選3
        if(only_cand_ele_idx[3]!=4'd15)begin map[only_cand_ele_idx[3]][HN_col_idx]<=4'd4; end //唯一候選4
        if(only_cand_ele_idx[4]!=4'd15)begin map[only_cand_ele_idx[4]][HN_col_idx]<=4'd5; end //唯一候選5
        if(only_cand_ele_idx[5]!=4'd15)begin map[only_cand_ele_idx[5]][HN_col_idx]<=4'd6; end //唯一候選6
        if(only_cand_ele_idx[6]!=4'd15)begin map[only_cand_ele_idx[6]][HN_col_idx]<=4'd7; end //唯一候選7
        if(only_cand_ele_idx[7]!=4'd15)begin map[only_cand_ele_idx[7]][HN_col_idx]<=4'd8; end //唯一候選8
        if(only_cand_ele_idx[8]!=4'd15)begin map[only_cand_ele_idx[8]][HN_col_idx]<=4'd9; end //唯一候選9
        ...
        if(only_cand_ele_idx[0]!=4'd15)begin map[only_cand_row[0]][only_cand_col[0]]<=4'd1; end //唯一候選1
        if(only_cand_ele_idx[1]!=4'd15)begin map[only_cand_row[1]][only_cand_col[1]]<=4'd2; end //唯一候選2
        if(only_cand_ele_idx[2]!=4'd15)begin map[only_cand_row[2]][only_cand_col[2]]<=4'd3; end //唯一候選3
        if(only_cand_ele_idx[3]!=4'd15)begin map[only_cand_row[3]][only_cand_col[3]]<=4'd4; end //唯一候選4
        if(only_cand_ele_idx[4]!=4'd15)begin map[only_cand_row[4]][only_cand_col[4]]<=4'd5; end //唯一候選5
        if(only_cand_ele_idx[5]!=4'd15)begin map[only_cand_row[5]][only_cand_col[5]]<=4'd6; end //唯一候選6
        if(only_cand_ele_idx[6]!=4'd15)begin map[only_cand_row[6]][only_cand_col[6]]<=4'd7; end //唯一候選7
        if(only_cand_ele_idx[7]!=4'd15)begin map[only_cand_row[7]][only_cand_col[7]]<=4'd8; end //唯一候選8
        if(only_cand_ele_idx[8]!=4'd15)begin map[only_cand_row[8]][only_cand_col[8]]<=4'd9; end //唯一候選9
