        ...
        for(j=0;j<9;j=j+1)begin
            ...
            if(EVAL_HN_tag==2'd0)begin
                ...
                if(only_cand_ele[0]!=4'd15&&(i==only_cand_row[0]&&j==only_cand_col[0]))updated_map[i][j]=9'd0;
                    ...
                    if(only_cand_ele[0]!=4'd15&&(i==only_cand_row[0]||j==only_cand_col[0]||(3*(i/3))+(j/3) ==only_cand_blk[0]))
                        updated_map[i][j][only_cand_ele[0]-1'd1]=1'b0; // wash if command candidate
                    if(only_cand_ele[1]!=4'd15&&(i==only_cand_row[1]||j==only_cand_col[1]||(3*(i/3))+(j/3)==only_cand_blk[1]))
                        updated_map[i][j][only_cand_ele[1]-1'd1]=1'b0; 
                    if(only_cand_ele[2]!=4'd15&&(i==only_cand_row[2]||j==only_cand_col[2]||(3*(i/3))+(j/3)==only_cand_blk[2]))
                        updated_map[i][j][only_cand_ele[2]-1'd1]=1'b0; 
                    if(only_cand_ele[3]!=4'd15&&(i==only_cand_row[3]||j==only_cand_col[3]||(3*(i/3))+(j/3)==only_cand_blk[3]))
                        updated_map[i][j][only_cand_ele[3]-1'd1]=1'b0; 
                    if(only_cand_ele[4]!=4'd15&&(i==only_cand_row[4]||j==only_cand_col[4]||(3*(i/3))+(j/3)==only_cand_blk[4]))
                        updated_map[i][j][only_cand_ele[4]-1'd1]=1'b0; 
                    if(only_cand_ele[5]!=4'd15&&(i==only_cand_row[5]||j==only_cand_col[5]||(3*(i/3))+(j/3)==only_cand_blk[5]))
                        updated_map[i][j][only_cand_ele[5]-1'd1]=1'b0; 
                    if(only_cand_ele[6]!=4'd15&&(i==only_cand_row[6]||j==only_cand_col[6]||(3*(i/3))+(j/3)==only_cand_blk[6]))
                        updated_map[i][j][only_cand_ele[6]-1'd1]=1'b0; 
                    if(only_cand_ele[7]!=4'd15&&(i==only_cand_row[7]||j==only_cand_col[7]||(3*(i/3))+(j/3)==only_cand_blk[7]))
                        updated_map[i][j][only_cand_ele[7]-1'd1]=1'b0; 
                    if(only_cand_ele[8]!=4'd15&&(i==only_cand_row[8]||j==only_cand_col[8]||(3*(i/3))+(j/3)==only_cand_blk[8]))
...
always@(posedge clk or negedge rst_n)begin
    ...
    //EVAL_cand case 2 (find candiadte only)
        ...
        //case 2: check_row_HN
        if(only_cand_ele[0]!=4'd15)begin map[only_cand_row[0]][only_cand_col[0]]<=only_cand_ele[0]; end 
        if(only_cand_ele[1]!=4'd15)begin map[only_cand_row[1]][only_cand_col[1]]<=only_cand_ele[1]; end 
        if(only_cand_ele[2]!=4'd15)begin map[only_cand_row[2]][only_cand_col[2]]<=only_cand_ele[2]; end 
        if(only_cand_ele[3]!=4'd15)begin map[only_cand_row[3]][only_cand_col[3]]<=only_cand_ele[3]; end 
        if(only_cand_ele[4]!=4'd15)begin map[only_cand_row[4]][only_cand_col[4]]<=only_cand_ele[4]; end 
        if(only_cand_ele[5]!=4'd15)begin map[only_cand_row[5]][only_cand_col[5]]<=only_cand_ele[5]; end 
        if(only_cand_ele[6]!=4'd15)begin map[only_cand_row[6]][only_cand_col[6]]<=only_cand_ele[6]; end 
        if(only_cand_ele[7]!=4'd15)begin map[only_cand_row[7]][only_cand_col[7]]<=only_cand_ele[7]; end 
        if(only_cand_ele[8]!=4'd15)begin map[only_cand_row[8]][only_cand_col[8]]<=only_cand_ele[8]; end 
