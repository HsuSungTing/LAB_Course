...
always@(posedge clk or negedge rst_n)begin
  if(!rst_n)begin
    A_cnt<=4'd0; B_cnt<=4'd0;
  end
  else if(((input_cnt>=27&&matrix_size_q==0)||(input_cnt>=123&&matrix_size_q==1))&&global_cnt<=21)begin
    A_cnt<=A_cnt+1; B_cnt<=B_cnt+1;
  end
  else if(cur_state==CLEAR)begin
    A_cnt<=4'd0; B_cnt<=4'd0;
  end
...
always@(*)begin
  ...
  if(global_cnt<=14) begin
      a_in[0][0]=A_row[0][A_cnt]; 
      a_in[1][0]=A_row[1][A_cnt]; 
      a_in[2][0]=A_row[2][A_cnt]; 
      a_in[3][0]=A_row[3][A_cnt];
      a_in[4][0]=A_row[4][A_cnt]; 
      a_in[5][0]=A_row[5][A_cnt]; 
      a_in[6][0]=A_row[6][A_cnt]; 
      a_in[7][0]=A_row[7][A_cnt];
  end else begin
  ...
  if(global_cnt>=1 && global_cnt<=15) begin
      a_in[0][1]=A_row[0][A_cnt-1]; 
      a_in[1][1]=A_row[1][A_cnt-1];
      a_in[2][1]=A_row[2][A_cnt-1]; 
      a_in[3][1]=A_row[3][A_cnt-1];
      a_in[4][1]=A_row[4][A_cnt-1]; 
      a_in[5][1]=A_row[5][A_cnt-1];
      a_in[6][1]=A_row[6][A_cnt-1]; 
      a_in[7][1]=A_row[7][A_cnt-1];
  end else begin
  ...
  if(global_cnt>=2 && global_cnt<=16) begin
      a_in[0][2]=A_row[0][A_cnt-2]; 
      a_in[1][2]=A_row[1][A_cnt-2];
      a_in[2][2]=A_row[2][A_cnt-2]; 
      a_in[3][2]=A_row[3][A_cnt-2];
      a_in[4][2]=A_row[4][A_cnt-2]; 
      a_in[5][2]=A_row[5][A_cnt-2];
      a_in[6][2]=A_row[6][A_cnt-2]; 
      a_in[7][2]=A_row[7][A_cnt-2];
  end else begin
  ...
  if(global_cnt>=3 && global_cnt<=17) begin
      a_in[0][3]=A_row[0][A_cnt-3];
      a_in[1][3]=A_row[1][A_cnt-3];
      a_in[2][3]=A_row[2][A_cnt-3]; 
      a_in[3][3]=A_row[3][A_cnt-3];
      a_in[4][3]=A_row[4][A_cnt-3]; 
      a_in[5][3]=A_row[5][A_cnt-3];
      a_in[6][3]=A_row[6][A_cnt-3]; 
      a_in[7][3]=A_row[7][A_cnt-3];
  end else begin
  ...
  if(global_cnt>=4 && global_cnt<=18) begin
      a_in[0][4]=A_row[0][A_cnt-4]; 
      a_in[1][4]=A_row[1][A_cnt-4]; 
      a_in[2][4]=A_row[2][A_cnt-4]; 
      a_in[3][4]=A_row[3][A_cnt-4]; 
      a_in[4][4]=A_row[4][A_cnt-4]; 
      a_in[5][4]=A_row[5][A_cnt-4]; 
      a_in[6][4]=A_row[6][A_cnt-4]; 
      a_in[7][4]=A_row[7][A_cnt-4]; 
  end else begin
  ...
  if(global_cnt>=5 && global_cnt<=19) begin
      a_in[0][5]=A_row[0][A_cnt-5]; 
      a_in[1][5]=A_row[1][A_cnt-5]; 
      a_in[2][5]=A_row[2][A_cnt-5]; 
      a_in[3][5]=A_row[3][A_cnt-5]; 
      a_in[4][5]=A_row[4][A_cnt-5]; 
      a_in[5][5]=A_row[5][A_cnt-5]; 
      a_in[6][5]=A_row[6][A_cnt-5]; 
      a_in[7][5]=A_row[7][A_cnt-5]; 
  end else begin
  ...
  if(global_cnt>=6 && global_cnt<=20) begin
      a_in[0][6]=A_row[0][A_cnt-6]; 
      a_in[1][6]=A_row[1][A_cnt-6]; 
      a_in[2][6]=A_row[2][A_cnt-6]; 
      a_in[3][6]=A_row[3][A_cnt-6]; 
      a_in[4][6]=A_row[4][A_cnt-6]; 
      a_in[5][6]=A_row[5][A_cnt-6]; 
      a_in[6][6]=A_row[6][A_cnt-6]; 
      a_in[7][6]=A_row[7][A_cnt-6]; 
  end else begin
  ...
  if(global_cnt>=7 && global_cnt<=21) begin
      a_in[0][7]=A_row[0][A_cnt-7]; 
      a_in[1][7]=A_row[1][A_cnt-7]; 
      a_in[2][7]=A_row[2][A_cnt-7]; 
      a_in[3][7]=A_row[3][A_cnt-7]; 
      a_in[4][7]=A_row[4][A_cnt-7]; 
      a_in[5][7]=A_row[5][A_cnt-7]; 
      a_in[6][7]=A_row[6][A_cnt-7]; 
      a_in[7][7]=A_row[7][A_cnt-7]; 
  end else begin
...
always@(*)begin
  ...
  if(global_cnt>=0 && global_cnt<=14) begin
      b_in[0][0]=B_row[0][B_cnt]; b_in[0][1]=B_row[1][B_cnt]; 
      b_in[0][2]=B_row[2][B_cnt]; b_in[0][3]=B_row[3][B_cnt];
      b_in[0][4]=B_row[4][B_cnt]; b_in[0][5]=B_row[5][B_cnt];
      b_in[0][6]=B_row[6][B_cnt]; b_in[0][7]=B_row[7][B_cnt];
  end else begin
  ...
  if(global_cnt>=1 && global_cnt<=15) begin
      b_in[1][0]=B_row[0][B_cnt-1]; b_in[1][1]=B_row[1][B_cnt-1]; 
      b_in[1][2]=B_row[2][B_cnt-1]; b_in[1][3]=B_row[3][B_cnt-1];
      b_in[1][4]=B_row[4][B_cnt-1]; b_in[1][5]=B_row[5][B_cnt-1];
      b_in[1][6]=B_row[6][B_cnt-1]; b_in[1][7]=B_row[7][B_cnt-1];
  end else begin
  ...
  if(global_cnt>=2 && global_cnt<=16) begin
      b_in[2][0]=B_row[0][B_cnt-2]; b_in[2][1]=B_row[1][B_cnt-2]; 
      b_in[2][2]=B_row[2][B_cnt-2]; b_in[2][3]=B_row[3][B_cnt-2];
      b_in[2][4]=B_row[4][B_cnt-2]; b_in[2][5]=B_row[5][B_cnt-2];
      b_in[2][6]=B_row[6][B_cnt-2]; b_in[2][7]=B_row[7][B_cnt-2];
  end else begin
  ...
  if(global_cnt>=3 && global_cnt<=17) begin
      b_in[3][0]=B_row[0][B_cnt-3]; b_in[3][1]=B_row[1][B_cnt-3]; 
      b_in[3][2]=B_row[2][B_cnt-3]; b_in[3][3]=B_row[3][B_cnt-3];
      b_in[3][4]=B_row[4][B_cnt-3]; b_in[3][5]=B_row[5][B_cnt-3];
      b_in[3][6]=B_row[6][B_cnt-3]; b_in[3][7]=B_row[7][B_cnt-3];
  end else begin
  ...
  if(global_cnt>=4 && global_cnt<=18) begin
      b_in[4][0]=B_row[0][B_cnt-4]; b_in[4][1]=B_row[1][B_cnt-4]; 
      b_in[4][2]=B_row[2][B_cnt-4]; b_in[4][3]=B_row[3][B_cnt-4];
      b_in[4][4]=B_row[4][B_cnt-4]; b_in[4][5]=B_row[5][B_cnt-4];
      b_in[4][6]=B_row[6][B_cnt-4]; b_in[4][7]=B_row[7][B_cnt-4];
  end else begin
  ...
  if(global_cnt>=5 && global_cnt<=19) begin
      b_in[5][0]=B_row[0][B_cnt-5]; b_in[5][1]=B_row[1][B_cnt-5]; 
      b_in[5][2]=B_row[2][B_cnt-5]; b_in[5][3]=B_row[3][B_cnt-5];
      b_in[5][4]=B_row[4][B_cnt-5]; b_in[5][5]=B_row[5][B_cnt-5];
      b_in[5][6]=B_row[6][B_cnt-5]; b_in[5][7]=B_row[7][B_cnt-5];
  end else begin
  ...
  if(global_cnt>=6 && global_cnt<=20) begin
      b_in[6][0]=B_row[0][B_cnt-6]; b_in[6][1]=B_row[1][B_cnt-6]; 
      b_in[6][2]=B_row[2][B_cnt-6]; b_in[6][3]=B_row[3][B_cnt-6];
      b_in[6][4]=B_row[4][B_cnt-6]; b_in[6][5]=B_row[5][B_cnt-6];
      b_in[6][6]=B_row[6][B_cnt-6]; b_in[6][7]=B_row[7][B_cnt-6];
  end else begin
  ...
  if(global_cnt>=7 && global_cnt<=21) begin
      b_in[7][0]=B_row[0][B_cnt-7]; b_in[7][1]=B_row[1][B_cnt-7]; 
      b_in[7][2]=B_row[2][B_cnt-7]; b_in[7][3]=B_row[3][B_cnt-7];
      b_in[7][4]=B_row[4][B_cnt-7]; b_in[7][5]=B_row[5][B_cnt-7];
      b_in[7][6]=B_row[6][B_cnt-7]; b_in[7][7]=B_row[7][B_cnt-7];
  end else begin
...
//Part 2 Comb Logic
reg signed [39:0] sum_out [1:13];

adder8 add1(
    .in0(mul_out[0][1]), .in1(mul_out[1][0]),   .in2(0),               .in3(0),
    .in4(0),              .in5(0),              .in6(0),               .in7(0),
    .sum(sum_out[1])
);

adder8 add2(
    .in0(mul_out[0][2]), .in1(mul_out[1][1]),   .in2(mul_out[2][0]),   .in3(0),
    .in4(0),               .in5(0),             .in6(0),               .in7(0),
    .sum(sum_out[2])
);
...
adder8 add12(
    .in0(mul_out[5][7]), .in1(mul_out[6][6]),   .in2(mul_out[7][5]),   .in3(0),
    .in4(0),               .in5(0),             .in6(0),               .in7(0),
    .sum(sum_out[12])
);

adder8 add13(
    .in0(mul_out[6][7]), .in1(mul_out[7][6]),   .in2(0),               .in3(0),
    .in4(0),               .in5(0),             .in6(0),               .in7(0),
    .sum(sum_out[13])
);
...
always@(posedge clk or negedge rst_n)begin
  if(!rst_n)begin
    ...
    diagnal_sum[1]<=diagnal_sum[1]+sum_out[1];
    diagnal_sum[2]<=diagnal_sum[2]+sum_out[2];
    ...
    diagnal_sum[12]<=diagnal_sum[12]+sum_out[12];
    diagnal_sum[13]<=diagnal_sum[13]+sum_out[13];
