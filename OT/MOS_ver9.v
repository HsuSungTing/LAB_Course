...
always@(posedge clk or negedge rst_n)begin
  ...
  else if(((input_cnt>=27&&matrix_size_q==0)||(input_cnt>=123&&matrix_size_q==1)) && global_cnt<=22)begin
    //共15 cycle
    if(global_cnt==8) diagnal_sum[0]<=cur_sum[0][0];
    else if(global_cnt>=9&&global_cnt<=21)diagnal_sum[global_cnt-8]<=sum_out;
    else if(global_cnt==22)diagnal_sum[14]<=cur_sum[7][7];
  end
  else if(cur_state==CLEAR)begin
    for(i=0;i<15;i=i+1)begin
      diagnal_sum[i]<=40'd0;   
...
always@(*)begin
  if(global_cnt==9)begin
    add_in[0]=cur_sum[0][1]; 
    add_in[1]=cur_sum[1][0]; 
    add_in[2]=40'd0;
    add_in[3]=40'd0;
    add_in[4]=40'd0;
    add_in[5]=40'd0;
    ...
    add_in[0]=cur_sum[0][2]; 
    add_in[1]=cur_sum[1][1]; 
    add_in[2]=cur_sum[2][0];
    add_in[3]=40'd0;
    add_in[4]=40'd0;
    add_in[5]=40'd0;
    add_in[6]=40'd0;
    ...
    add_in[0]=cur_sum[0][3]; 
    add_in[1]=cur_sum[1][2]; 
    add_in[2]=cur_sum[2][1];
    add_in[3]=cur_sum[3][0]; 
    add_in[4]=40'd0;
    add_in[5]=40'd0;
    add_in[6]=40'd0;
    add_in[7]=40'd0;
  ...
  add_in[0]=cur_sum[0][4];
  add_in[1]=cur_sum[1][3];
  add_in[2]=cur_sum[2][2];
  add_in[3]=cur_sum[3][1];
  add_in[4]=cur_sum[4][0];
  add_in[5]=40'd0;
  add_in[6]=40'd0;
  add_in[7]=40'd0;
  end
  else if(global_cnt==13)begin
    add_in[0]=cur_sum[0][5];
    add_in[1]=cur_sum[1][4];
    add_in[2]=cur_sum[2][3];
    add_in[3]=cur_sum[3][2];
    add_in[4]=cur_sum[4][1];
    add_in[5]=cur_sum[5][0];
    add_in[6]=40'd0;
    add_in[7]=40'd0;
  end
  else if(global_cnt==14)begin
    add_in[0]=cur_sum[0][6];
    add_in[1]=cur_sum[1][5];
    add_in[2]=cur_sum[2][4];
    add_in[3]=cur_sum[3][3];
    add_in[4]=cur_sum[4][2];
    add_in[5]=cur_sum[5][1];
    add_in[6]=cur_sum[6][0];
    add_in[7]=40'd0;
  end
  else if(global_cnt==15)begin
    add_in[0]=cur_sum[0][7];
    add_in[1]=cur_sum[1][6];
    add_in[2]=cur_sum[2][5];
    add_in[3]=cur_sum[3][4];
    add_in[4]=cur_sum[4][3];
    add_in[5]=cur_sum[5][2];
    add_in[6]=cur_sum[6][1];
    add_in[7]=cur_sum[7][0];
  end
  else if(global_cnt==16)begin
    add_in[0]=cur_sum[1][7];
    add_in[1]=cur_sum[2][6];
    add_in[2]=cur_sum[3][5];
    add_in[3]=cur_sum[4][4];
    add_in[4]=cur_sum[5][3];
    add_in[5]=cur_sum[6][2];
    add_in[6]=cur_sum[7][1];
    add_in[7]=40'd0;
  end
  else if(global_cnt==17)begin
    add_in[0]=cur_sum[2][7];
    add_in[1]=cur_sum[3][6];
    add_in[2]=cur_sum[4][5];
    add_in[3]=cur_sum[5][4];
    add_in[4]=cur_sum[6][3];
    add_in[5]=cur_sum[7][2];
    add_in[6]=40'd0;
    add_in[7]=40'd0;
  end
  else if(global_cnt==18)begin
    add_in[0]=cur_sum[3][7];
    add_in[1]=cur_sum[4][6];
    add_in[2]=cur_sum[5][5];
    add_in[3]=cur_sum[6][4];
    add_in[4]=cur_sum[7][3];
    add_in[5]=40'd0;
    add_in[6]=40'd0;
    add_in[7]=40'd0;
  end
  else if(global_cnt==19)begin
    add_in[0]=cur_sum[4][7];
    add_in[1]=cur_sum[5][6];
    add_in[2]=cur_sum[6][5];
    add_in[3]=cur_sum[7][4];
    add_in[4]=40'd0;
    add_in[5]=40'd0;
    add_in[6]=40'd0;
    add_in[7]=40'd0;
    ...
    add_in[0]=cur_sum[5][7];
    add_in[1]=cur_sum[6][6];
    add_in[2]=cur_sum[7][5];
    add_in[3]=40'd0;
    add_in[4]=40'd0;
    add_in[5]=40'd0;
    add_in[6]=40'd0;
    ...
    add_in[0]=cur_sum[6][7];
    add_in[1]=cur_sum[7][6];
    add_in[2]=40'd0;
    add_in[3]=40'd0;
    add_in[4]=40'd0;
    add_in[5]=40'd0;
...
module adder8 (
    input  wire signed [39:0] a0,
    input  wire signed [39:0] a1,
    input  wire signed [39:0] a2,
    input  wire signed [39:0] a3,
    input  wire signed [39:0] a4,
    input  wire signed [39:0] a5,
    input  wire signed [39:0] a6,
    input  wire signed [39:0] a7,
    output wire signed [39:0] sum
);
