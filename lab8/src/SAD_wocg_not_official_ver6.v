...
//Part 2 Comb Logic
reg signed [61:0] ASP [0:7][0:7];
reg [3:0] ASP_big_cnt, ASP_small_cnt;
always@(*)begin
    if(cur_state==EVAL_A)begin  //Q K^T
        a_in[0]={{24{Q[ASP_big_cnt][0][15]}},Q[ASP_big_cnt][0][14:0]};
        a_in[1]={{24{Q[ASP_big_cnt][1][15]}},Q[ASP_big_cnt][1][14:0]};
        a_in[2]={{24{Q[ASP_big_cnt][2][15]}},Q[ASP_big_cnt][2][14:0]};
        a_in[3]={{24{Q[ASP_big_cnt][3][15]}},Q[ASP_big_cnt][3][14:0]};
        a_in[4]={{24{Q[ASP_big_cnt][4][15]}},Q[ASP_big_cnt][4][14:0]};
        a_in[5]={{24{Q[ASP_big_cnt][5][15]}},Q[ASP_big_cnt][5][14:0]};
        a_in[6]={{24{Q[ASP_big_cnt][6][15]}},Q[ASP_big_cnt][6][14:0]};
        a_in[7]={{24{Q[ASP_big_cnt][7][15]}},Q[ASP_big_cnt][7][14:0]};
