...
wire signed [14:0] part_1_det_out;      
...
reg signed [14:0] part_1_det_in_q;
wire signed [27:0] part_2_det_out;
...
module det_eval_part1(
    ...
    input  signed [5:0] l,
    input  signed [5:0] o,
    output signed [14:0] part_1_det_out
);
    // x = (k * p) - (l * o)
...
module det_eval_part2(
    input  signed [5:0]  a,
    input  signed [5:0]  f,
    input  signed [14:0] part_1_det_in,
    output signed [27:0] part_2_det_out
);
