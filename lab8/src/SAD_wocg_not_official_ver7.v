...
always@(*)begin
    if(cur_state==EVAL_A)begin  //Q K^T
        a_in[0]=Q[ASP_big_cnt][0];
        a_in[1]=Q[ASP_big_cnt][1];
        a_in[2]=Q[ASP_big_cnt][2];
        a_in[3]=Q[ASP_big_cnt][3];
        a_in[4]=Q[ASP_big_cnt][4];
        a_in[5]=Q[ASP_big_cnt][5];
        a_in[6]=Q[ASP_big_cnt][6];
        a_in[7]=Q[ASP_big_cnt][7];
