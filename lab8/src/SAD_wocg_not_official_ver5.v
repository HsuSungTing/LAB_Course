...
//Part 2 Comb Logic
reg signed [31:0] a_in [0:7];
reg signed [15:0] b_in [0:7];
wire signed [51:0] mul_out_step_2_5;
...
module mul_comb (
    ...
    output signed [51:0] sum 
);
    // products: each 48-bit signed
    wire signed [48:0] p0 = a0 * b0;
    wire signed [48:0] p1 = a1 * b1;
    wire signed [48:0] p2 = a2 * b2;
    wire signed [48:0] p3 = a3 * b3;
    wire signed [48:0] p4 = a4 * b4;
    wire signed [48:0] p5 = a5 * b5;
    wire signed [48:0] p6 = a6 * b6;
    wire signed [48:0] p7 = a7 * b7;
    // combinational sum
