...
always@(*)begin
    ...
    OUTPUT: begin
        if(pt_cnt<=pt_num_q-1'd1&&out_cnt>=drop_len-1) next_state=CLEAR_small;
        else if(pt_cnt==pt_num_q-1'd1&&out_cnt>=drop_len-1)next_state=CLEAR_big;
