...
find_delta_part1 find_delta_part1_inst(
    ...
    .result_A(result_A_d),  
    //type B output
    .sorted_A0(sorted_Ai_d[0]), 
    .sorted_A1(sorted_Ai_d[1]),
    .sorted_A2(sorted_Ai_d[2]),
    .sorted_A3(sorted_Ai_d[3]),
    .char_A0(sorted_char_d[0]),
    .char_A1(sorted_char_d[1]),
    .char_A2(sorted_char_d[2]),
    .char_A3(sorted_char_d[3]),
    //type C output
...
module find_delta_part1 (
    ...
    output logic [15:0] sorted_A0,  //type B
    output logic [15:0] sorted_A1,
    output logic [15:0] sorted_A2,
    output logic [15:0] sorted_A3,
    output logic [1:0]  char_A0,
    output logic [1:0]  char_A1,
    output logic [1:0]  char_A2,
    output logic [1:0]  char_A3,
