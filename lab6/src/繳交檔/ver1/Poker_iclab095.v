...
wire [3:0] out_num [0:4][0:IP_WIDTH-1];    //每個人排序過的NUM
wire [3:0] out_chosen_type [0:IP_WIDTH-1]; //11-2
wire [23:0] player_score [0:IP_WIDTH-1];   //{type,num[0],...,num[4]}
...
//===step 1先選出唯一會發生royal或是straight flush的suit===
...
wire [3:0] final_Flush_num [0:4];    //每個suit的結果
