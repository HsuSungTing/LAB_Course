...
always@(*)begin
    for(i=0;i<9;i=i+1)begin
        player_winrate[i]=(player_score[i]*100)/(16740);
    end
end
...
always@(posedge clk or negedge rst_n)begin
    if(!rst_n)begin
        ...
        out_win_rate<= {player_winrate[8],player_winrate[7],player_winrate[6],player_winrate[5],player_winrate[4],player_winrate[3],player_winrate[2],player_winrate[1],player_winrate[0]};
        out_valid<=1'b1;
    end
    else begin
        out_win_rate<=63'd0; out_valid<=1'b0;
