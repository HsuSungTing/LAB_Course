...
reg straight_exist_bool;
always@(*)begin
    if(num_cnt[12]>=3'd1 && num_cnt[11]>=3'd1 && num_cnt[10]>=3'd1 && num_cnt[9]>=3'd1 && num_cnt[8]>=3'd1)begin
        // A K Q J 10
    ...
    else if(num_cnt[11]>=3'd1 && num_cnt[10]>=3'd1 && num_cnt[9]>=3'd1 && num_cnt[8]>=3'd1 && num_cnt[7]>=3'd1)begin
        // K Q J 10 9
        straight_num[0]=4'd13; straight_num[1]=4'd12; straight_num[2]=4'd11; straight_num[3]=4'd10; straight_num[4]=4'd9;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[10]>=3'd1 && num_cnt[9]>=3'd1 && num_cnt[8]>=3'd1 && num_cnt[7]>=3'd1 && num_cnt[6]>=3'd1)begin
        // Q J 10 9 8
        straight_num[0]=4'd12; straight_num[1]=4'd11; straight_num[2]=4'd10; straight_num[3]=4'd9; straight_num[4]=4'd8;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[9]>=3'd1 && num_cnt[8]>=3'd1 && num_cnt[7]>=3'd1 && num_cnt[6]>=3'd1 && num_cnt[5]>=3'd1)begin
        // J 10 9 8 7
        straight_num[0]=4'd11; straight_num[1]=4'd10; straight_num[2]=4'd9; straight_num[3]=4'd8; straight_num[4]=4'd7;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[8]>=3'd1 && num_cnt[7]>=3'd1 && num_cnt[6]>=3'd1 && num_cnt[5]>=3'd1 && num_cnt[4]>=3'd1)begin
        // 10 9 8 7 6
        straight_num[0]=4'd10; straight_num[1]=4'd9; straight_num[2]=4'd8; straight_num[3]=4'd7; straight_num[4]=4'd6;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[7]>=3'd1 && num_cnt[6]>=3'd1 && num_cnt[5]>=3'd1 && num_cnt[4]>=3'd1 && num_cnt[3]>=3'd1)begin
        // 9 8 7 6 5
        straight_num[0]=4'd9; straight_num[1]=4'd8; straight_num[2]=4'd7; straight_num[3]=4'd6; straight_num[4]=4'd5;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[6]>=3'd1 && num_cnt[5]>=3'd1 && num_cnt[4]>=3'd1 && num_cnt[3]>=3'd1 && num_cnt[2]>=3'd1)begin
        // 8 7 6 5 4
        straight_num[0]=4'd8; straight_num[1]=4'd7; straight_num[2]=4'd6; straight_num[3]=4'd5; straight_num[4]=4'd4;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[5]>=3'd1 && num_cnt[4]>=3'd1 && num_cnt[3]>=3'd1 && num_cnt[2]>=3'd1 && num_cnt[1]>=3'd1)begin
        // 7 6 5 4 3
        straight_num[0]=4'd7; straight_num[1]=4'd6; straight_num[2]=4'd5; straight_num[3]=4'd4; straight_num[4]=4'd3;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[4]>=3'd1 && num_cnt[3]>=3'd1 && num_cnt[2]>=3'd1 && num_cnt[1]>=3'd1 && num_cnt[0]>=3'd1)begin
        // 6 5 4 3 2
        straight_num[0]=4'd6; straight_num[1]=4'd5; straight_num[2]=4'd4; straight_num[3]=4'd3; straight_num[4]=4'd2;
        straight_exist_bool=1'b1;
    end
    else if(num_cnt[3]>=3'd1 && num_cnt[2]>=3'd1 && num_cnt[1]>=3'd1 && num_cnt[0]>=3'd1 && num_cnt[12]>=3'd1)begin
        // 5 4 3 2 A (這邊先設定A=1，後續可寫成14)
