...
endclass
random_today today_rand = new() ;

class random_MP;                          
    randc logic [15:0] MP;
    constraint MP_constraint{MP inside {[0:65535]};}
endclass
random_MP MP_rand = new(); 
...
task make_random_input; begin
    ...
    //spec 2 in_mode
    //void'(mode_rand.randomize());
    //in_mode=(type_x_mode_rand.type_x_mode%3);
    //in_mode=mode_rand.mode;
