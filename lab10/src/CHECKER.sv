...
property SPEC_8_DAY;
    ...
    (inf.date_valid===1) |->
        case (inf.D.d_date[0].M)
            1,3,5,7,8,10,12:  inf.D.d_date[0].D inside {[1:31]};
            4,6,9,11:          inf.D.d_date[0].D inside {[1:30]};
            2:                inf.D.d_date[0].D inside {[1:28]};
            default:          0; // illegal month
        endcase;
endproperty
...
assert property(SPEC_2_login)               else print_Assertion_violate_msg("2");
assert property(SPEC_2_levelup)             else print_Assertion_violate_msg("2");
assert property(SPEC_2_battle)              else print_Assertion_violate_msg("2");
assert property(SPEC_2_skill)               else print_Assertion_violate_msg("2");
assert property(SPEC_2_inactive)            else print_Assertion_violate_msg("2");
assert property(SPEC_3_warnmsg)             else print_Assertion_violate_msg("3");
assert property(SPEC_4_login)               else print_Assertion_violate_msg("4");
assert property(SPEC_4_levelup)             else print_Assertion_violate_msg("4");
assert property(SPEC_4_battle)              else print_Assertion_violate_msg("4");
assert property(SPEC_4_skill)               else print_Assertion_violate_msg("4");
assert property(SPEC_4_inactive)            else print_Assertion_violate_msg("4");
assert property(SPEC_5_sel_action_valid)    else print_Assertion_violate_msg("5");
assert property(SPEC_5_type_valid)          else print_Assertion_violate_msg("5");
assert property(SPEC_5_mode_valid)          else print_Assertion_violate_msg("5");
assert property(SPEC_5_monster_valid)       else print_Assertion_violate_msg("5");
assert property(SPEC_5_date_valid)          else print_Assertion_violate_msg("5");
assert property(SPEC_5_MP_valid)            else print_Assertion_violate_msg("5");
assert property(SPEC_5_player_no_valid)     else print_Assertion_violate_msg("5");
assert property(SPEC_6_outvalid_one_cycle)  else print_Assertion_violate_msg("6");
assert property(SPEC_7_next_input)          else print_Assertion_violate_msg("7");
assert property(SPEC_8_MON)                 else print_Assertion_violate_msg("8");
assert property(SPEC_8_DAY)                 else print_Assertion_violate_msg("8");
assert property(SPEC_9_AR_AW)               else print_Assertion_violate_msg("9");
