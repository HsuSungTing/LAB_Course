...
parameter SEED = 445445445;
parameter PATUM = 1000;
        ...
        for (p = 0; p < 256; p = p + 1) begin
            ...
            case (mem_id)
                0: begin
                    ...
                    `ifdef POST
                            got_b = $root.TESTBED.u_CHIP.MEM0.Memory[addr8];
                    `else
                ...
                1: begin
                    addr8 = local_img*256 + p;
                    `ifdef POST
                            got_b = $root.TESTBED.u_CHIP.MEM1.Memory[addr8];
                    `else
                ...
                2: begin
                    addr8 = local_img*256 + p;
                    `ifdef POST
                            got_b = $root.TESTBED.u_CHIP.MEM2.Memory[addr8];
                    `else
                ...
                3: begin
                    addr8 = local_img*256 + p;
                    `ifdef POST
                            got_b = $root.TESTBED.u_CHIP.MEM3.Memory[addr8];
                    `else
                ...
                4: begin
                    ...
                    `ifdef POST
                            w16 = $root.TESTBED.u_CHIP.MEM4.Memory[addr16];
                    `else
                ...
                5: begin
                    addr16 = local_img*(256/2) + (p >> 1);
                    `ifdef POST
                            w16 = $root.TESTBED.u_CHIP.MEM5.Memory[addr16];
                    `else
                ...
                6: begin
                    ...
                    `ifdef POST
                            w32 = $root.TESTBED.u_CHIP.MEM6.Memory[addr32];
                    `else
                ...
                7: begin
                    addr32 = local_img*(256/4) + (p >> 2);
                    `ifdef POST
                            w32 = $root.TESTBED.u_CHIP.MEM7.Memory[addr32];
                    `else
