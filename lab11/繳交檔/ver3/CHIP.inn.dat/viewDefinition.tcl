...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SUMA180_2048X16X1BM1_BC.lib\
    ${::IMEX::libVar}/mmmc/SUMA180_4096X8X1BM4_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/lib/typ/SUMA180_2048X16X1BM1_WC.lib\
    ${::IMEX::libVar}/lib/typ/SUMA180_4096X8X1BM4_WC.lib]\
   -si\
