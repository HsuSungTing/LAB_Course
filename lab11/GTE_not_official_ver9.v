...
always@(posedge clk or negedge rst_n)begin
	...
	//case 0: INPUT_1 sram write 
		...
		//step 1 din & cnt & addr
		if(write_sram_idx>=0&&write_sram_idx<=63)begin	
		...
		//case 1 write to sram 4~5
		else if(write_sram_idx>=64 && write_sram_idx<=95)begin
			//case 1-0:
			...
			//case 1-1: can write
				...
				sram_2048_din<={sram_2048_din[15:8],data};	
			end
		end
		//case 2 write to sram 6~7
		else if(write_sram_idx>=96 && write_sram_idx<=127)begin	
			//case 1-0
			...
			//case 1-1: can write
				...
				sram_1024_din<={sram_1024_din[31:8],data};	
			end
		end
	end
	//case 1: EVAL_sram_read sram raed
	else if(cur_state==EVAL_sram_read)begin
		//read_sram_idx<=mem_read_idx;	//ex: 113-7*16=1	
...
assign mem0_addr = sram_4096_addr;	
