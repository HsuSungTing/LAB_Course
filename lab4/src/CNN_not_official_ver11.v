...
always@(*)begin
    ...
    else if(conv_cnt==109)begin
        div_in_a=exp_of_z[0]; div_in_b=sum_of_exp;
    end
    else if(conv_cnt==110)begin
        div_in_a=exp_of_z[1]; div_in_b=sum_of_exp;
    end
    else if(conv_cnt==111)begin
...
always @(*) begin
    ...
    //step 7 sofmax
    else if(conv_cnt==105) exp_in=img_after_FC2[0];
    else if(conv_cnt==106) exp_in=img_after_FC2[1];
    else if(conv_cnt==107) exp_in=img_after_FC2[2];
end
...
always@(posedge clk or negedge rst_n)begin
    ...
    else if(conv_cnt==105)exp_of_z[0]<=exp_out;
    else if(conv_cnt==106)exp_of_z[1]<=exp_out;
    else if(conv_cnt==107)exp_of_z[2]<=exp_out;
    else if(conv_cnt==108)sum_of_exp<=sum3_out[0];
    else if(conv_cnt==109)img_after_softmax[0]<=div_out;
    else if(conv_cnt==110)img_after_softmax[1]<=div_out;
    else if(conv_cnt==111)img_after_softmax[2]<=div_out;
end
//====================
