...
module tb_CNN;
    ...
    initial begin
        ...
        for (i = 0; i < 72; i = i+1) begin
            ...
            if(i==0)begin
                task_number= 1; mode = 2'b10;
            end
            else begin
                task_number= 0; mode = 2'b00;
            end
            ...
            if (i < 57) Weight_Bias = 32'h40800000 + i; // float 4.0 + i
            else Weight_Bias = 0;

            if(i<5) capacity_cost=32'h40800000 + i; // float 4.0 + i
            else capacity_cost=0;
            @(negedge clk);
        end
